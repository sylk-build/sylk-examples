...
export declare const Hello: {
    ...
    decode(input: _m0.Reader | Uint8Array, length?: number | undefined): Hello;
...
export declare type HelloWorldServiceService = typeof HelloWorldServiceService;
...
export declare const HelloWorldServiceClient: {
    new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions> | undefined): HelloWorldServiceClient;
